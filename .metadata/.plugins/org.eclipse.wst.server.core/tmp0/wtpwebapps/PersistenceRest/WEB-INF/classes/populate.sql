...
INSERT INTO `ADDRESS` (city,state,street,member_id) VALUES ('Fairfield','Iowa','Main','1');
INSERT INTO `ADDRESS` (city,state,street,member_id) VALUES ('Batavia','Iowa','Maple','2');
